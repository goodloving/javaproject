...
<script type="text/javascript">
	function changeImg(obj){
		obj.src="/Register/checkImg?time="+new Date().getTime();
	}
	...
	function chechForm(){
		...
		// 检查密码
		var pValue = document.getElementById("inputPassword3").value;
		if(pValue==""){
			alert("密码不能为空");
			return false;
		}
		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<form class="form-horizontal" action="/Register/login"  method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<img onclick="changeImg(this)" src="/Register/checkImg" align="center"/>
							</div>
						</div>
						<div class="form-group">
